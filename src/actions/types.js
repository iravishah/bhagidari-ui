...
export const FETCH_DEBIT_INSTALLMENTS = "FETCH_DEBIT_INSTALLMENTS";
export const CREATE_DEBIT_INSTALLMENT = "CREATE_DEBIT_INSTALLMENT";
export const EDIT_DEBIT_INSTALLMENT = "EDIT_DEBIT_INSTALLMENT";
export const FETCH_DEBIT_INSTALLMENT = "FETCH_DEBIT_INSTALLMENT";
export const DELETE_DEBIT_INSTALLMENT = "DELETE_DEBIT_INSTALLMENT";